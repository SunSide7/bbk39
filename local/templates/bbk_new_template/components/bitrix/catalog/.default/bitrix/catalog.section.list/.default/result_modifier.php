...
echo 'DEFAULT -> SECTIONS:<pre>' . print_r(count($arResult['SECTIONS']), true) . '</pre>';
echo 'RESULT_MODIFIER -> SHOW_PARENT_NAME:   <pre>' . print_r($arParams['SHOW_PARENT_NAME'], true) . '</pre>';
//die();

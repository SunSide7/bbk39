                ...
                <ul>
                    ...
                    <?foreach ($arResult["SECTIONS"] as $arIdx => $arSection):?>
                        ...
                        <? if(!$arSection['IBLOCK_SECTION_ID']) { ?>
                            ...
                            <!--                                <ul class="configurator-sidebar-option">-->
                            <!--                                    <span class="configurator-sidebar-option-title">-->
                            <!--                                        <img src="--><?php //= SITE_TEMPLATE_PATH ?><!--/images/configurator/option-3.png" alt="">-->
                            <!--                                        <span>Выберите цвет фасада</span>-->
                            <!--                                    </span>-->
                            <!--                                    <span class="configurator-sidebar-option-dialog">Нажмите чтобы выбрать фасад</span>-->
                            <!--                                    <li class="lvl-1">-->
                            <!--                                        <img src="--><?php //= SITE_TEMPLATE_PATH ?><!--/images/configurator/floor-option-1.png" alt=""><span>Стены Lvl 1-1</span>-->
                            <!--                                        -->
                            <!--                                        <div class="lvl-2-content">-->
                            <!--                                            <ul>-->
                            <!--                                                <li>-->
                            <!--                                                    <img src="--><?php //= SITE_TEMPLATE_PATH ?><!--/images/configurator/floor-option-1.png" alt=""><span>Стены Lvl 2-1 #1</span>-->
                            <!--                                                    <div class="content"><img src="--><?php //= SITE_TEMPLATE_PATH ?><!--/images/configurator/3_1.png" alt=""></div>-->
                            <!--                                                    <div class="content-2"><img src="--><?php //= SITE_TEMPLATE_PATH ?><!--/images/configurator/3_1-2.png" alt=""></div>-->
                            <!--                                                </li>-->
                            <!--                                            </ul>-->
                            <!--                                        </div>-->
                            <!--                                    </li>-->

...
?>
	...
	<div style="margin-top: 16px">
		<div class="label"><b>
<!--                --><?php //=GetMessage("sys_forgot_pass_login1")?>
                E-mail <span class="req-red">*</span>
            </b></div>
		<div>
			<input class="form-control" type="text" name="USER_LOGIN" value="<?=$arResult["USER_LOGIN"]?>" />
			<input type="hidden" name="USER_EMAIL" />
		</div>
		<div style="margin-top: 15px;"><?echo GetMessage("sys_forgot_pass_note_email")?></div>
	</div>
...
<?endif;?>
	...
	<div style="margin-top: 20px">
		<input class="btn_blue" type="submit" name="send_account_info" value="<?=GetMessage("AUTH_SEND")?>" />
	</div>
</form>
